...
def test_stealth_crawler_parses_fusion_layout_without_matching_hero_class():
        ...
        <div class="fusion-card-item short-assignment section hstack flex-wrap">
          <div class="hstack gap-2 me-auto flex-1">
            <div class="flex-1">
              <div class="h4 title">
                Materials Check
                <span class="fusion-popover px-1" data-bs-content-url="/student/classes/11511739/events/27564524/hint">
                  <svg><path d="icon"></path></svg>
                </span>
              </div>
            </div>
          </div>
          <a href="/student/classes/11511739">AP English Language Arts I (Hons) - Group 2 (Grade 10)</a>
          <p>Due: September 11, 2026 at 12:10 PM</p>
          <a href="/student/classes/11511739/core_tasks/27564524/dropbox">Upload</a>
        </div>
      </body>
    </html>
    """
    ...
    task = crawler.fetch_task_details(class_id=11511739, task_id=27564524)
    assert task is not None
