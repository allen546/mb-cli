    ...
    def test_returns_description(self, client, sample_task_detail_html):
        with rm.Mocker() as m:
            ...
            detail = client.get_task_detail(
                "https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026"
            )
...
class TestGetClassGrades:
    def test_parses_grades(self, client, sample_grades_page_html):
        with rm.Mocker() as m:
            m.get(
                "https://bj80.managebac.cn/student/classes/1000023/core_tasks",
...
class TestSubmitFile:
    def test_submit_success(self, client, sample_dropbox_page_html, tmp_path: Path):
        ...
        with rm.Mocker() as m:
            ...
            m.post(
                "https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026/dropbox/upload",
                json={"ok": True},
            )
...
class TestGetCached:
    ...
    def test_submit_file_invalidates_cache(self, client, tmp_path: Path, sample_dropbox_page_html):
        test_file = tmp_path / "hw.pdf"
        test_file.write_bytes(b"content")
        client.cache.put("https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026", "cached task detail", 200)
        ...
        assert client.cache.get("https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026") is None
...
class TestParseTaskUrl:
    ...
    def test_full_url(self):
        url = "https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026"
        assert parse_task_url(url) == ("1000023", "1000026")

    def test_full_url_with_subpath(self):
        url = "https://bj80.managebac.cn/student/classes/1000023/core_tasks/1000026/dropbox"
        assert parse_task_url(url) == ("1000023", "1000026")
