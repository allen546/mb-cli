...
class TestViewTaskTool:
    def test_view_task_by_url(self, mock_build_client):
        ...
        result = view_task(
            task_url="https://bj80.managebac.cn/student/classes/1000014/core_tasks/1000099"
        )
        data = json.loads(result)
    ...
    def test_view_task_id_from_url_with_query_string(self, mock_build_client):
        ...
        data = json.loads(
            view_task(
                task_url="https://bj80.managebac.cn/student/classes/1000014/core_tasks/1000099?foo=1"
            )
        )
        assert data["task"]["id"] == "1000099"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "https://bj80.managebac.cn/student/dashboard",
            "https://bj80.managebac.cn/student/classes/1000014",
...
class TestSubmitFileTool:
    def test_submit_by_url(self, mock_build_client, tmp_path):
        ...
        result = submit_file(
            task_id="https://bj80.managebac.cn/student/classes/1000014/core_tasks/1000099",
