...
All relative to `https://{school}.{domain}` (e.g. `https://myschool.managebac.cn`).
...
```
mb login --school myschool --domain managebac.cn -e user@example.com
mb login --school myschool -e user@example.com -c "cookie_value"
```
...
mb view https://myschool.managebac.cn/.../core_tasks/1000025/discussions
mb view --subject EL 1000025
```
...
```
mb submissions --id 1000025
mb submissions 1000025
mb submissions --id 1000025 --submit file.docx
mb submissions --id 1000025 --list
mb submissions --id 1000025 --delete asset_80753784
```
