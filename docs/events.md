...
| :--- | :--- | :---: | :--- | :--- |
| `task_id` | `integer` / `string` | No | ManageBac internal unique ID for the task. | `27535638` |
| `class_id` | `integer` / `string` | Yes | ManageBac internal class / course ID. | `11511739` |
...
| `url` | `string` | Yes | Direct canonical URL to the task details page. | `"https://beijing101.managebac.cn/student/classes/11511739/core_tasks/27535638"` |
...
```json
{
  ...
  "data": {
    ...
    "grade_letter": "A",
    "grade_score": "96 / 100",
    "url": "https://beijing101.managebac.cn/student/classes/11511739/core_tasks/27419820"
  }
}
```
...
```json
{
  ...
  "event_id": "evt_27535638_reminder_1h",
...
```json
{
  ...
  "data": {
    ...
    "file_url": "https://beijing101.managebac.cn/student/classes/11511739/files/99812/download",
...
```json
{
  ...
  "data": {
    ...
    "url": "https://beijing101.managebac.cn/student/classes/11511739/messages/55120"
  }
}
```
...
- For deadline reminders, the ID reflects the task and threshold (e.g. `evt_27535638_reminder_1h`).
