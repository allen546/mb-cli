...
client = ManageBacClient.from_config(profile="beijing101")
```
...
client = ManageBacClient(
    school="bj80",               # Subdomain, e.g. "bj80" for "bj80.managebac.cn"
...
# Helpful properties
print(client.school)         # "bj80"
print(client.subdomain)      # "bj80" (alias)
print(client.domain)         # "managebac.cn"
print(client.base)           # "https://bj80.managebac.cn"
...
task_detail = client.get_task_detail(
    "/student/classes/11460718/core_tasks/27080372",
    bypass_cache=False,
)
...
task = client.find_task_by_id(task_id="27535638", max_pages=20)
```
...
class_tasks = client.get_class_tasks(class_id="11460718", fetch_details=False)
```
...
```python
submissions = client.get_submissions(class_id="11460711", task_id="27254393")
...
```python
feedback = client.get_teacher_feedback(class_id="11460711", task_id="27254393")
...
```python
# Get class roster
classes = client.get_classes()  # Returns dict: { "11460711": "English Language Arts", ... }

# Get detailed gradebook and expected final grade for one class
grades_data = client.get_class_grades(class_id="11460711")
...
client.invalidate_task_cache(class_id="11460711", task_id="27254393")

# Force bypass cache on specific reads
detail = client.get_task_detail("/student/classes/11460711/core_tasks/27254393", bypass_cache=True)
grades = client.get_class_grades(class_id="11460711", bypass_cache=True)
```
