...
Teacher names (e.g. `A. Teacher`, `Zhang Wei | 张伟`) are intentionally omitted from notification bodies. This conserves precious vertical line space for assignment requirements and deadlines.
...
curl -X POST http://127.0.0.1:42617/webhook \
  ...
  -d '{
    ...
    "data": {
      ...
      "url": "https://school.managebac.cn/student/classes/1000010/core_tasks/1000014"
    }
  }'
```
...
[INFO] Dispatching to Bark:
       ...
       截止: 09-18 23:59 (后天)
       Sound: 'bell', Priority: 6, URL: 'https://school.managebac.cn/student/classes/1000010/core_tasks/1000014'
