...
task_detail = client.get_task_detail("/student/classes/11460718/core_tasks/27080372")
if task_detail:
    print(task_detail.get("description"))

# 3. Check class grades and computed expected scores
grades = client.get_class_grades(class_id="11460711")
...
mb view 27080372                        # view single task by ID
mb view "https://your-school.managebac.com/student/classes/11460718/core_tasks/27080372"

# File Submission
mb submit 27254393 homework.pdf         # upload file to assignment dropbox

# Grades & Analytics
mb grades                               # list all enrolled classes
mb grades --class-id 11460711           # detailed task grades for one class
