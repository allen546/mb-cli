...
def test_format_event_task_created_with_released_grade_shows_grade_posted():
    ...
    payload = {
        ...
        "data": {
            ...
            "url": "https://beijing101.managebac.cn/student/classes/11512072/core_tasks/27569975",
        },
    }
    ...
    assert sound == "chime"
    assert priority == 7
    assert url == "https://beijing101.managebac.cn/student/classes/11512072/core_tasks/27569975"
    lines = message.split("\n")
    assert len(lines) == 3
