...
def submit_file(
    ...
    Args:
        task_id: Task ID or full URL (e.g. "1000026" or "https://bj80.managebac.cn/student/classes/1000001/core_tasks/1000099")
...
def get_teacher_feedback(
    ...
    Args:
        ...
        task_url: Full task URL (e.g. "https://bj80.managebac.cn/student/classes/1000001/core_tasks/1000099")
        school: School subdomain
        domain: Base domain
        cookie: Session cookie override
        profile: Profile name
